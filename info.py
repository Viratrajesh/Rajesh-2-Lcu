...
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002794359760'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002794359760'))
...
#Other Funtions
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '864000'))
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://www.askmovies.workers.dev.koyeb.app")
